...
public class ThumbPanel extends JPanel
	 ...
	 * 
	 */
	private static final long serialVersionUID = -700243062262638364L;
    ...
    public ThumbPanel(PDFFile file) {
        ...
        if (file != null) {
            ...
            xloc = new int[count];
            setPreferredSize(new Dimension(defaultWidth, lineheight));
        ...
        for (int i = 0; i < images.length; i++) {
            ...
            if (clip.intersects(new Rectangle(x, y, w, lineheight))) {
                ...
                if (i == showing) {
                    ...
                    g.drawRect(x, y, w - 1, lineheight - border);
                    g.drawRect(x + 1, y + 1, w - 3, lineheight - border);
                }
            }
